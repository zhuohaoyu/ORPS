...
PROGRAMMER_USER_PROMPT_LATER_ROUNDS = """Here's the criticism of the previous solution:

{criticism}

Please improve your solution based on our discussion. Remember to strictly follow our format and rules."""
...
class CodeProcessSupervisionLbpp_noA(BaseStep):  
    ...
    def __init__(
            ...
            select_best_node_method: str = "process_score",
    ...
    def generate_origin_node_from_lbpp(self):
        ...
        for task_id, nodes in task_id_to_nodes.items():
            nodes.sort(key=lambda x: (x.current_process_score), reverse=True)
