...
PROGRAMMER_SYSTEM_PROMPT = """You are a competitive programming contestant, thinking about the problem given by the user. The user will give you a problem, and you need to think about it. You can only generate one line of thought at a time."""

CRITIC_SYSTEM_PROMPT = """You are a helpful code reviewer, you will be guiding a programmer by listening to the programmer's thoughts then give a score for the overall reasoning process they have shared, and your score will be used to guide the programmer's reasoning process on the problem. Your score should be a integer ranged between 1 to 5, where 5 stands for a very good reasoning path and potentially might lead to a great solution. Now, this is the problem and test cases you will be focusing on: {base_prompt}"""
...
class CodeProcessSupervisionLbpp_lineSelf(BaseStep):  
